class NewProjectTemplate():
    """
    Used to create HTML message to send in email to all users when a new project is created.
    """

    def __init__(self, project_name, project_page_link, project_creator, project_members, project_status, person_name, app_link):
                            ...
                            <html>
                                ...
                                >
                                    ...
                                    <div style="line-height: 1.3; font-style: 1.2em;">
                                        ...
                                        "
                                        >
                                        <div><strong>{self.project_creator}</strong></div>
                                        </span>
                    
                                        created a new project in Pesticide.
                                        </div>
    ...
    def for_all_users(self):
        ...
        for member in self.project_members:
            members += f"""
                          ...
                          """
        email_template = self.common_1 + members + self.common_2
