class NewIssueTemplate():
    """
    Used to create HTML message to send in email to project members when new issue is reported in their project..
    """

    def __init__(self, project_name, project_page_link, reported_by, issue_title, issue_tags, person_name, app_link):
                            ...
                            <html>
                                ...
                                >
                                    ...
                                    <div style="line-height: 1.3; font-style: 1.2em;">
                                        ...
                                        "
                                        >
                                        <div><strong>{self.reported_by}</strong></div>
                                        </span>
                    
                                        just added a new issue in your project
