class ProjectStatusUpdateTemplate():
    """
    Used to create HTML message to send in email to all users when a project's status is created.
    """

    def __init__(self, project_name, project_page_link, old_project_status, project_status, status_updated_by, person_name, app_link):
        self.project_name = project_name
        self.project_page_link = project_page_link
        self.old_project_status = old_project_status
                            ...
                            <html>
                                ...
                                >
                                    ...
                                    <div style="line-height: 1.3; font-style: 1.2em;">
                                        ...
                                        updated {self.project_name}'s status from {self.old_project_status} to <b>{self.project_status}</b>.
                                        </div>
    ...
    def for_all_users(self):
        """
        For all users of the app.
        """

        email_template = self.common_1
